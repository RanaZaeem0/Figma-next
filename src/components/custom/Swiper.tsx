...
interface SwiperData {
    img1 : string;
    img2:string;img3:string;img4:string,view:string
}

export default function Swiper1({img1,img2,img3,img4,view}:SwiperData) {
    ...
    >
      {
        sp1data.map((item,index) =>{
          ...
          >
          <Image
          className='h-[64vh]' width={200} height={200}
           src={item.img} alt="" />
        </SwiperSlide>
        })
      }
